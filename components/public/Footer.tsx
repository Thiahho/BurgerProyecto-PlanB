...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="sticky bottom-0 w-full z-50">
      ...
      <div className="h-6 bg-gradient-to-t from-secondary/80 to-transparent"></div>

      <div className="bg-secondary/80 backdrop-blur-lg border-t border-white/10 pb-safe">
